...
class ASTETrainingInstructor(BaseTrainingInstructor):
    ...
    #                     postfix = "Dev Precision:{:>.2f} Recall:{:>.2f} F1:{:>.2f}(max:{:>.2f})".format(
    #                         joint_precision * 100,
    #                         joint_recall * 100,
    #                         joint_f1 * 100,
    #                         max_fold_f1 * 100,
    ...
    #         print(f"Precision: {joint_precision * 100:.2f}%")
    #         print(f"Recall: {joint_recall * 100:.2f}%")
    #         print(f"F1 Score: {joint_f1 * 100:.2f}%")
    ...
    #                         postfix = "Dev Acc:{:>.2f}(max:{:>.2f}) Dev F1:{:>.2f}(max:{:>.2f}) Dev Precision:{:>.2f}(max:{:>.2f}) Dev Recall:{:>.2f}(max:{:>.2f})".format(
    #                             test_acc * 100,
    #                             max_fold_acc * 100,
    #                             f1 * 100,
    #                             max_fold_f1 * 100,
    ...
    #     max_test_acc = np.max(fold_test_acc)
    #     max_test_f1 = np.max(fold_test_f1)
    #     max_test_precision = np.max(fold_test_precision)
    #     max_test_recall = np.max(fold_test_recall)
